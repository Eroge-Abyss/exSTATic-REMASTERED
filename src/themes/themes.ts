...
export const themeList: ThemeInfo[] = [
  ...
  { id: "coral-rose", name: "Coral Rose", primary: "#e77d8f", background: "#1f1a1c", accent: "#2c2428" },
  { id: "golden-amber", name: "Golden Amber", primary: "#f3b23d", background: "#1c1a17", accent: "#292520" },
  { id: "desert-sand", name: "Desert Sand", primary: "#d8b172", background: "#1d1b18", accent: "#2a2722" },
  ...
  { id: "cobalt-blue", name: "Cobalt Blue", primary: "#4e80ee", background: "#161b26", accent: "#212838" },
];
...
export const themes: Record<ThemeId, ThemeTokens> = {
  ...
  "coral-rose": {
    ...
    "--exs-title": "#e77d8f",
    "--exs-text": "#a4979a",
    "--exs-text-strong": "#fdf6f7",
    "--exs-text-muted": "#706467",
    "--exs-accent": "#e77d8f",
    "--exs-accent-dim": "#cf6577",
    "--exs-accent-hover": "#b34d5f",
    "--exs-accent-text": "#1c0f12",
    "--exs-icon": "#ffffff",
    "--exs-menu-bg": "#2c2428",
    "--exs-menu-text": "#e7dedf",
    "--exs-border": "#3f3439",
    "--exs-border-dim": "#1f1a1c",
    "--exs-card-bg": "#e77d8f",
    "--exs-card-border": "transparent",
    "--exs-card-line": "transparent",
    "--exs-card-text": "#1c0f12",
    "--exs-btn-primary-bg": "#b3485b",
    "--exs-btn-primary-text": "#ffffff",
    "--exs-heatmap-empty": "rgba(231, 125, 143, 0.08)",
    "--exs-heatmap-lo": "#f4b4be",
    "--exs-heatmap-hi": "#b3485b",
    "--exs-section-shadow": "0 4px 24px rgba(0, 0, 0, 0.45)",
  },
  "golden-amber": {
    "--exs-backdrop": "#1c1a17",
    ...
    "--exs-title": "#f3b23d",
    "--exs-text": "#a39c91",
    "--exs-text-strong": "#fdfbf7",
    "--exs-text-muted": "#6e685f",
    "--exs-accent": "#f3b23d",
    "--exs-accent-dim": "#d99b26",
    "--exs-accent-hover": "#bf8315",
    "--exs-accent-text": "#1c1507",
    "--exs-icon": "#ffffff",
    "--exs-menu-bg": "#292520",
    "--exs-menu-text": "#e5ded4",
    "--exs-border": "#3d372e",
    "--exs-border-dim": "#1c1a17",
    "--exs-card-bg": "#f3b23d",
    "--exs-card-border": "transparent",
    "--exs-card-line": "transparent",
    "--exs-card-text": "#1c1507",
    "--exs-btn-primary-bg": "#b87714",
    "--exs-btn-primary-text": "#ffffff",
    "--exs-heatmap-empty": "rgba(243, 178, 61, 0.08)",
    "--exs-heatmap-lo": "#f9d48b",
    "--exs-heatmap-hi": "#b87714",
    "--exs-section-shadow": "0 4px 24px rgba(0, 0, 0, 0.45)",
  },
  "desert-sand": {
    "--exs-backdrop": "#1d1b18",
    ...
    "--exs-title": "#d8b172",
    "--exs-text": "#9e978d",
    "--exs-text-strong": "#fbf8f2",
    "--exs-text-muted": "#6b655c",
    "--exs-accent": "#d8b172",
    "--exs-accent-dim": "#be9758",
    "--exs-accent-hover": "#a27f42",
    "--exs-accent-text": "#1b160e",
    "--exs-icon": "#ffffff",
    "--exs-menu-bg": "#2a2722",
    "--exs-menu-text": "#e2ded6",
    "--exs-border": "#3c3730",
    "--exs-border-dim": "#1d1b18",
    "--exs-card-bg": "#d8b172",
    "--exs-card-border": "transparent",
    "--exs-card-line": "transparent",
    "--exs-card-text": "#1b160e",
    "--exs-btn-primary-bg": "#9c793d",
    "--exs-btn-primary-text": "#ffffff",
    "--exs-heatmap-empty": "rgba(216, 177, 114, 0.08)",
    "--exs-heatmap-lo": "#eccea0",
    "--exs-heatmap-hi": "#9c793d",
    "--exs-section-shadow": "0 4px 24px rgba(0, 0, 0, 0.45)",
  },
  "cobalt-blue": {
    "--exs-backdrop": "#161b26",
    ...
    "--exs-title": "#4e80ee",
    "--exs-text": "#8d98ab",
    "--exs-text-strong": "#f0f4fa",
    "--exs-text-muted": "#5b667a",
    "--exs-accent": "#4e80ee",
    "--exs-accent-dim": "#386ad6",
    "--exs-accent-hover": "#2454bf",
    "--exs-accent-text": "#ffffff",
    "--exs-icon": "#ffffff",
    "--exs-menu-bg": "#212838",
    "--exs-menu-text": "#d8e1ee",
    "--exs-border": "#2e394f",
    "--exs-border-dim": "#161b26",
    "--exs-card-bg": "#4e80ee",
    "--exs-card-border": "transparent",
    "--exs-card-line": "transparent",
    "--exs-card-text": "#ffffff",
    "--exs-btn-primary-bg": "#2b5ecf",
    "--exs-btn-primary-text": "#ffffff",
    "--exs-heatmap-empty": "rgba(78, 128, 238, 0.08)",
    "--exs-heatmap-lo": "#9cbbf7",
    "--exs-heatmap-hi": "#2659c9",
    "--exs-section-shadow": "0 4px 24px rgba(0, 0, 0, 0.45)",
  },
};
