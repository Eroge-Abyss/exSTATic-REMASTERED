...
export const themes: Record<ThemeId, ThemeTokens> = {
  ...
  "tadoku-default": {
    ...
    "--exs-card-bg": "#58447d",
    "--exs-card-border": "#8e6cd4",
    "--exs-card-line": "#8e6cd4",
  ...
  sakura: {
    ...
    "--exs-card-bg": "#793c5c",
    "--exs-card-border": "#c94e8c",
    "--exs-card-line": "#c94e8c",
    "--exs-card-text": "#ffffff",
  ...
  "ocean-blue": {
    ...
    "--exs-card-bg": "#3b517d",
    "--exs-card-border": "#5b7dd4",
    "--exs-card-line": "#5b7dd4",
    "--exs-card-text": "#ffffff",
  ...
  "forest-green": {
    ...
    "--exs-card-bg": "#465b38",
    "--exs-card-border": "#7da852",
    "--exs-card-line": "#7da852",
    "--exs-card-text": "#ffffff",
